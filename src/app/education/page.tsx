  ...
  const EduData = [
    {
      ...
      info: "Currently in the 3rd year (6th semester) of my undergraduate education at GITAM (Deemed to be University), Bengaluru. In this courses, I have gained a strong foundation in the core concepts of computer science and engineering, including programming, data structures, algorithms, operating systems, computer networks, database management systems, and software engineering.I have learnt how to solve problems using Data Structures and Algorithms, and how to design and develop software applications using Object-Oriented Programming. I have also gained a solid understanding of the fundamentals of Artificial Intelligence and Machine Learning, Deep Learning, Natural Language Processing, Computer Vision, and Data Science.",
      date: "2021 - Present",
      marks: "SGPA: 8.88/10",
      aggregate: "CGPA : 9.42/10",
    },
    {
      id: 2,
      head: "Higher Secondary (Board of Intermediate Education, Andhra Pradesh)",
      where: "Kuppam Junior College, Kuppam ",
    info: "Successfully completed the INERMEDIATE (Group-1) examination conducted by Board of Intermediate Education, Andhra Pradesh. I had subjects like Mathematics, Physics, Chemistry and English. This achievement showcases my understanding and proficiency in the core subjects related to Science and Mathematics.",
      date: "2019-2021",
