...
function ProfileCard() {
  return (
    <section className="lg:fixed se:mx-auto lg:left-0 bg-white rounded-sm flex flex-col justify-center se:px-[70px] se:py-[30px] sp:px-[50px] sp:py-[30px] sn:px-[40px] sn:py-[20px] si:px-[100px] si:py-[50px] sr:px-[100px] sr:py-[50px] px-8 sp:w-screen sn:w-screen se:w-[100vw] si:w-screen si:mx-auto sr:w-[900px] sr:mx-auto  lg:w-[250px] 2xl:w-[350px] min-h-screen  ">
      <Image
        className="mx-auto border-[2px] 2xl:border-[4px] border-[#FF4A2E] 2xl:w-[200px] 2xl:h-[200px] rounded-full p-1 2xl:p-2 si:w-[200px] si:h-[200px] sr:w-[250px] sr:h-[250px]"
        src={dp}
        alt="dp"
        width={110}
        height={110}
      />
      <div className="mt-[15px] 2xl:mt-[25px]  si:mt-[25px] sr:mt-[30px] flex flex-col gap-[10px] si:gap-[20px] sr:gap-[25px] text-center se:justify-center sp:justify-center sn:justify-center">
        <div>
          <p className="font-[600]  text-[18px] si:text-2xl sr:text-3xl 2xl:text-3xl ">
            Punith Dandluri
          </p>
          <p className="font-[400] text-gray-600  text-sm si:text-xl sr:text-2xl 2xl:text-2xl">
        ...
        <div className="flex flex-row gap-[5px] si:gap-[15px] sr:gap-[20px] 2xl:gap-[20px] justify-center">
          <a
            ...
            target="_blank"
            className="bg-[#FF4A2E] bg-opacity-80 rounded-full p-[5px] ">
            <Image
              src={insta}
              alt="instagram"
              className="si:w-[25px] si:h-[25px] sr:w-[30px] sr:h-[30px] 2xl:w-[25px] 2xl:h-[25px]"
            />
          </a>
          <a
        ...
        <hr />
        <div className="flex flex-col text-[12px] si:text-lg sr:text-xl 2xl:text-lg gap-[10px] text-left">
